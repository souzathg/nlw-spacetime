    ...
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] px-28 py-16">
        ...
        <div className="space-y-5">
          ...
          <a
            href=""
            className="text-sx inline-block rounded-full bg-green-500 px-5 py-3 font-alt uppercase leading-none text-black transition-colors hover:bg-green-600"
          >
            CADASTRAR LEMBRANÇA
          </a>
        </div>
        ...
        <div className="text-sm leading-relaxed text-gray-200">
          Feito com 💜 por{' '}
          <a
            href="https://github.com/souzathg"
            target="_blank"
            rel="noreferrer"
